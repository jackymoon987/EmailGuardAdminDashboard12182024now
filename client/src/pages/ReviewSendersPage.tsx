...
export default function ReviewSendersPage() {
  ...
  const mockSenders: EmailSender[] = [
    { domain: "@tidnewsletter.com", numberOfEmails: 1, lastEmail: "Dec 09 2024", subject: "ai/ml image generator 🖼️, openai's reinforcement fine-tuning 🎯, microsoft trolls..." },
  ...
  return (
    <div className="container mx-auto py-8 space-y-6">
      <div className="space-y-2">
        <h1 className="text-2xl font-bold">Review senders</h1>
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            ...
            <Button className="w-32">Save preferences</Button>
          </div>
        </div>
      </div>
    </div>
